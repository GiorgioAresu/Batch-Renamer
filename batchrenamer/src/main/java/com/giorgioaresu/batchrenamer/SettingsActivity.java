...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static final Preference.OnPreferenceChangeListener rememberRulesChangeListener = new Preference.OnPreferenceChangeListener() {
        @Override
        public boolean onPreferenceChange(Preference preference, Object o) {
            ...
            if (pref.isChecked()) {
                pref.setSummary(R.string.pref_description_remember_rules_unchecked);
            } else {
                pref.setSummary(R.string.pref_description_remember_rules_checked);
            }
            return true;
        }
    };
