...
public class DynamicListView extends ListView {
    ...
    private OnItemLongClickListener mOnItemLongClickListener =
            new OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    mCellIsMobile = true;
                    updateNeighborViews(mMobileItem);
    ...
    private BitmapDrawable getAndAddHoverView(View v) {
        ...
        Bitmap b = getBitmapWithFilter(v);
    ...
    /**
     * Draws a shade over the screenshot of the view passed in.
     */
    private Bitmap getBitmapWithFilter(View v) {
        Bitmap bitmap = getBitmapFromView(v);
        Canvas can = new Canvas(bitmap);

        Paint paint = new Paint();
        paint.setColorFilter(new LightingColorFilter(0x0, 0x8f8f8f));
        paint.setAlpha(127);
    ...
    private void handleCellSwitch() {
        ...
        View belowView = getView(mBelowItem);
        View mobileView = getView(mMobileItem);
        View aboveView = getView(mAboveItem);
        ...
        if (isBelow || isAbove) {
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    View switchView = getView(switchItem);
                    View mobileView = getView(mMobileItem);
    ...
    private void touchEventsEnded() {
        final View mobileView = getView(mMobileItem);
    ...
    private OnScrollListener mScrollListener = new OnScrollListener() {
        ...
        public void checkAndHandleFirstVisibleCellChange() {
            if (mCurrentFirstVisibleItem != mPreviousFirstVisibleItem) {
                if (mCellIsMobile && mMobileItem != null) {
                    updateNeighborViews(mMobileItem);
                    handleCellSwitch();
                }
            }
